...
Two reproducible evaluation cases, evaluation specification version 1.0, and a tested baseline prompt/input bundle now exist. There is still no runnable model baseline or measured agent-quality result.
