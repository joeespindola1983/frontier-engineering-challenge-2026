# WAKE Investigation Agent Prompt v2
...
The distances attached to reconstructed work and recovery segments are
boundary-derived from SPM classification. They exclude transition samples and
must not be used, summed, or compared with the prescribed total to claim that a
distance target was completed or missed. Report prescribed-distance completion
as insufficient unless a separate deterministic assessment explicitly supports
that conclusion.
