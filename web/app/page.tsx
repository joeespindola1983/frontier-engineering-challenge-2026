    ...
    <section className="club-overview" aria-labelledby="club-pulse-title">
      ...
      <section className="club-batch-validation" aria-labelledby="club-batch-validation-title">
        ...
        <div className="club-batch-funnel">
          ...
          <div><span>Reconstructed</span><strong>{intelligence.batch_validation.counts.sessions_reconstructed}</strong><small>water telemetry reconstructed</small></div>
        ...
        <div className="club-batch-boundary" role="note"><strong>38 water sessions reconstructed; 2 indoor records need a Concept2 adapter.</strong><span>Thirty-one water sessions had no material signal in the available evidence, three were recorded alternatives, one needs its plan, and one needs athlete context. Those states are not collapsed into “completed as planned.”</span></div>
      </section>
