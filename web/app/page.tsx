...
function ClubOverview({ onOpenCrew, onOpenAthlete }: { onOpenCrew: (crewId: string) => void; onOpenAthlete: (athleteId: string) => void }) {
  ...
  return (
    <section className="club-overview" aria-labelledby="club-pulse-title">
      <div className="club-overview-heading"><div><div className="kicker">Real-informed synthetic data · 17–28 Aug 2026</div><h2 id="club-pulse-title">Two-week club pulse</h2><p>Ten named crews share sixteen athletes across 2x, 4x, and 8x boats. WAKE surfaces the records that need attention without asking the coach to open every outing.</p></div><span className="saved-evidence-label">Saved data · No model call</span></div>
